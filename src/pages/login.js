...
import AppIcon from '../images/my-logo.png';
    ...
    render() {
        ...
        return (
            <Grid container className={classes.form}>
                <Grid item sm/>
                <Grid item sm>
                    <img src={AppIcon} alt="Logo" width="200px" height="200px" className={classes.image}/> 
                    ...
                    <form noValidate onSubmit={this.handleSubmit}>
                        ...
                        <br/>
                        <small>Dont have account? <Link to="/signup">Sign Up Here</Link></small>
                    </form>
                </Grid>
