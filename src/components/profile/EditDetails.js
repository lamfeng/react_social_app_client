                ...
                <Dialog open={this.state.open} onClose={this.handleClose} fullWidth maxWidth="sm">
                    ...
                    <DialogContent>
                        <form>
                            ...
                            <TextField name="website" type="text" label="Website" placeholder="Your personal website" className={classes.textField} value={this.state.website} onChange={this.handleChange} fullWidth/>
