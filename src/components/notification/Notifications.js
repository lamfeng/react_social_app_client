            ...
            notifications.map(not => {
                ...
                return (
                    <MenuItem key={not.createdAt} onClick={this.handleClose}>
                        {icon}
                        <Typography component={Link} variant="body1" to={`/users/${not.recipient}/scream/${not.screamId}`}>
        ...
        return (
            <Fragment>
                <Tooltip placement="top" title="Notifications">
                    <IconButton arial-owns={anchorEl ? 'simple-menu' : undefined} aria-haspopup="true" onClick={this.handleOpen}>
                        {notificationsIcon}
                    </IconButton>
                </Tooltip>
